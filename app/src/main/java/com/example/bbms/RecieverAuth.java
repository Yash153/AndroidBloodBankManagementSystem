...
import com.example.bbms.databinding.ActivityRecieverAuthBinding;
...
public class RecieverAuth extends AppCompatActivity {
    ...
    private void createRequest() {
        ...
        GoogleSignInOptions gso = new GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
                .requestIdToken("1006714038054-8musg185oci3u408knr56d6pm4hd7vhr.apps.googleusercontent.com")
                .requestEmail()
                .build();
